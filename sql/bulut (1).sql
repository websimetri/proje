...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 08 Haz 2015, 07:58:40
...
`id` int(11) NOT NULL,
  `sirket_id` int(11) NOT NULL,
  `kul_id` varchar(50) CHARACTER SET latin1 NOT NULL,
  `urun_id` varchar(50) CHARACTER SET latin1 NOT NULL,
...
(9, 1, 1, 'Bütün Kullanıcılar', 'Bütün kullanıcılara deneme mesajı', '2015-04-21 13:56:57'),
...
(18, 1, 'Son İçerik', 'Denemq', '<p>asdadsad</p>', '2015-05-20 11:07:06', 0);
...
(2, 'Yasin!', 'Kesim', 'yasin@yasin.com', '81dc9bdb52d04dc20036dbd8313ed055', '2015-04-09 00:00:00', '2015-04-09 00:00:00'),
...
(10, 'test', 'test', 'test@test.com', '091c4fcad24eff1de105f0be9a74e5ad', '2015-05-20 12:37:41', '2015-05-20 12:37:41'),
(11, 'asdada', 'test', 'mail1@mail.com', 'c0cb75e9c7207ebec6baba3185105b52', '2015-05-20 12:52:15', '2015-05-20 12:52:15');
...
`id` int(11) NOT NULL,
  ...
  `konu` varchar(500) CHARACTER SET latin1 NOT NULL,
  `mesaj` varchar(500) CHARACTER SET latin1 NOT NULL,
  `tarih` datetime NOT NULL,
...
(12, 1, '13131231', 12312, 0, '2015-12-31 12:59:00', '2015-12-31 12:59:00', '2015-05-22 09:58:23', 'admin/sirket/upload/2015-05/MQ==_20150522085823.jpg', '<iframe></iframe>', '12313', 12, 12, 1);
...
(1, 4, 'Yasin LTD.', 'Karşıda bir yerler. Kartal falan.', '+90 212 999 99 89', 'temp/croppedImg_3410.jpeg', 1, 'f02fa9eab7a86799b1f885774e441ec4', 'Yasin', 'Kesim', 'yasin@yasin.com', '827ccb0eea8a706c4c34a16891f84e7b', '2015-04-09 00:00:00', 1, '41.310824', '27.773438'),
...
(3, 1, '2,7,16', 'vaio', 'vaio ', 'Açıklamalar', '2015-06-03 11:38:06', 0.00, 1, 0, '', ''),
...
(17, 1, '1,5,6,15,9', 'asdsadsa', 'fdfsa', 'dfasdfasdf', '2015-05-21 07:55:05', 121.00, 0, 1, '1231313', '');
...
(17, 3, '3_18693774Bengal-Kaplani-resimleri-3.jpg', '3'),
(18, 3, '3_14600660e6Nnn5s (1).jpg', '3');
...
--
-- Tablo için indeksler `anket_oy_kontrol`
--
...
--
ALTER TABLE `kullanicilar`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Kullanıcı d''si',AUTO_INCREMENT=12;
--
