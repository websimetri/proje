...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 20 May 2015, 08:00:13
...
`id` int(11) NOT NULL,
  ...
  `adi` varchar(250) COLLATE utf8_bin NOT NULL,
  `klasor` varchar(250) COLLATE utf8_bin NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `urun_resimleri` (`id`, `id_urun`, `adi`, `klasor`) VALUES
(1, 3, 'upload/2015-05/MQ==_20150518072919.jpg', 'upload/2015-05/'),
(2, 3, 'upload/2015-05/MQ==_20150518072919.jpg', 'upload/2015-05/');
